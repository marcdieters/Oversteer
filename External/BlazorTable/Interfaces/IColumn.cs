...
namespace BlazorTable
{
    ...
    public interface IColumn<TableItem>
    {
        ...
        /// Show checkbox in header
        /// </summary>
        bool AllowRowClick { get; set; }

        /// <summary>
        /// Show more options button
        /// </summary>
        bool ShowMoreOptionsButton { get; set; }

        /// <summary>
        /// Disable more options button
        /// </summary>
        bool MoreOptionsButtonDisabled { get; set; }

        /// <summary>
        /// Action performed when the more options button is clicked
        /// </summary>
        Action<TableItem> MoreOptionsClickAction { get; set; }

        /// <summary>
        /// Shows a checkmark or X for true/false
        /// </summary>
        bool ShowTrueFalseIcons { get; set; }

        /// <summary>
        /// Fieldname for ShowTrueFalseIcons
        /// </summary>
        string BooleanFieldName { get; set; }

        /// <summary>
        /// Controls wether a column is visible or not
        /// </summary>
